		...
		<div class="mt-8 space-y-6">
			...
			<div class="flex flex-col gap-3">
				<form action="?/oauth" method="POST">
					<button
						type="submit"
						class="group relative flex w-full justify-center rounded-md border border-transparent bg-gray-800 px-4 py-2 text-sm font-medium text-white hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:outline-none"
					>
				...
				<button
					disabled
					type="button"
					class="group relative flex w-full cursor-not-allowed justify-center rounded-md border border-transparent bg-white px-4 py-2 text-sm font-medium text-gray-700 opacity-50 hover:bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none"
				>
					<span class="absolute inset-y-0 left-0 flex items-center pl-3">
			...
			<div class="relative">
				...
				<div class="relative flex justify-center text-sm">
					<span class="bg-gray-50 px-2 text-gray-500 dark:bg-gray-900">Or continue with</span>
				</div>
			</div>
